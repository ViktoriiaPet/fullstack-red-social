...
export default function CreateEvent() {
  ...
  return (
    <div className="container mt-4" style={{ color: theme.textColor }}>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <GoogleMap
            ...
            center={
              locationMap.lat && locationMap.lng ? locationMap : { lat: 40.4168, lng: -3.7038 }
        ...
        <div className="row">
          <div className="mb-3 col col-sm-12 col-md-8 col-lg-6">
            ...
            <input
              ...
              required
            />
            {errors.reservationLimitDateEvent && (
              <div className="text-danger">{errors.reservationLimitDateEvent}</div>
            )}
          </div>
        </div>
        <div className="row">
          <div className="mb-3 col col-sm-12 col-md-8 col-lg-6">
            <label htmlFor="minimoAsistentes" className="form-label">
              Numero minimo de asistentes
            </label>
            <input
              type="number"
              className="form-control"
              ...
              min="1"
            />
            {errors.assistantsMinEvent && (
              <div className="text-danger">{errors.assistantsMinEvent}</div>
            )}
          </div>
        </div>
        <div className="row">
          <div className="mb-3 col col-sm-12 col-md-8 col-lg-6">
            <label htmlFor="maximoAsistentes" className="form-label">
              Numero máximo de asistentes
            </label>
            <input
              type="number"
              className="form-control"
              ...
              min="1"
            />
            {errors.assistantsMaxEvent && (
              <div className="text-danger">{errors.assistantsMaxEvent}</div>
            )}
          </div>
        </div>
        <div className="row">
      ...
      {positiveCreate && <OkModal title={"Evento creado con éxito"} />}
    </div>
  )
}
